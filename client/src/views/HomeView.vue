<script>
// import CardCharacters from "../components/card-characters.vue";
...
<template>
  <section>
    <div class="wrapper">
      <h2>
        <strong>All Games<span>( 4 )</span></strong>
      </h2>
        ...
        <figure class="article">
          ...
          <figcaption>
            ...
            <p>
              ...
              than that, as the all-new Flockheart’s Gamble Arcana item for Ogre Magi
    ...
    <div class="container">
      <div class="component">
        <h2><strong>All Comics</strong></h2>
        <ul class="align">
          <li>          
            <figure class="book">
              <!-- Front -->
