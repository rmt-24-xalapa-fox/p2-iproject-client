    ...
    <footer id="footer" class="footer color-bg">
                                ...
                                <ul class="toggle-footer" style="">
                                    <li class="media">
                                        ...
                                        <div class="media-body">
                                            <p>Jakarta, 789 Main rd, Anytown, CA 12345 IDN</p>
                                        </div>
                                    </li>
                                    <li class="media">
                                        <div class="pull-left"> <span class="icon fa-stack fa-lg"> <i
                                        ...
                                        <div class="media-body">
                                            <p> + (021) 123-4567 / + (021) 456-7890</p>
                                        </div>
                                    </li>
                                    <li class="media">
                                        <div class="pull-left"> <span class="icon fa-stack fa-lg"> <i
                                                    class="fa fa-envelope fa-stack-1x fa-inverse"></i> </span> </div>
                                        <div class="media-body"> <span><a href="#">nmarafita@gmail.com</a></span> </div>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="copyright-bar">
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-4 no-padding"><a target="_blank"
                        href="#"></a> </div>
