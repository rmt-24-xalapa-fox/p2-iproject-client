...
<template>
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
        <div class="container">
            <a href="#" class="navbar-brand" style="font-family: 'Comfortaa', 'cursive'">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a href="#" class="nav-link active" aria-current="page"><img
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li v-if="!hasLoggedIn">
                                <button type="button" class="btn btn-primary dropdown-item" data-bs-toggle="modal" data-bs-target="#registerModal">
                                    Register
                                </button>
                            </li>
                            <li v-if="hasLoggedIn">
