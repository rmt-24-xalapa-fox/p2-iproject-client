    ...
    <div>
        <form @submit.prevent="createImgURL(this.image)">
            <div class="row">         
                ...
                <div class="col-6">
                    <div class="form-group row">
                        <label for="imgUrl" class="col-4 col-form-label" style="color:white">Upload Image</label> 
                        <div class="col-6">
                        ...
                        <span id="imgUrlHelpBlock" class="form-text text-muted" style="color:white">Image ratio 1:1</span>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="price" class="col-4 col-form-label" style="color:white">Price</label> 
                        <div class="col-6">
                        <div class="input-group">
                            <div class="input-group-prepend">
